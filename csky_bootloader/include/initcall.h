...
#define framework_initcall(fn)          __define_initcall(fn, 5)
#define framework_initcall_sync(fn)     __define_initcall(fn, 5s)
#define fs_initcall(fn)                 __define_initcall(fn, 6)
#define fs_initcall_sync(fn)            __define_initcall(fn, 6s)
